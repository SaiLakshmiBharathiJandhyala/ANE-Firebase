...
package
{
	...
	/**	
	 * Sample application for using the Storage Native Extension
	 * 
	...
	public class TestStorage extends Sprite
	{
		 ...
		 * Class constructor 
		 */	
		public function TestStorage( appKey:String=APP_KEY )
		{
			super();
			_appKey = appKey;
			create();
		...
		private function init( ):void
		{
			try
			{
				Storage.init( _appKey );
				
				message( "Storage Supported: " + Storage.isSupported );
				message( "Storage Version:   " + Storage.service.version );
