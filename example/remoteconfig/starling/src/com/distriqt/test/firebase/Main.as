...
package com.distriqt.test.firebase
{
	...
	public class Main extends Sprite implements ILogger
	{
		...
		private var _tests		: FirebaseConfigTests;
		...
		{
			_tests = new FirebaseConfigTests( this );
		}
		...
		private function createUI():void
		{
			...
			addAction( "setDefaults :Config", _tests.setDefaults );
			addAction( "getKeysByPrefix :Config", _tests.getKeysByPrefix );
			
			addAction( "getString :Config", _tests.getString );
			
			addAction( "fetch :Config", _tests.fetch );
			
			addAction( "info :Config", _tests.getInfo );
