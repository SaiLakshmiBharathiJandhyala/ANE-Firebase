...
package
{
	...
	public class TestDatabase extends Sprite
	{
		 ...
		 * Class constructor 
		 */	
		public function TestDatabase( appKey:String=APP_KEY )
		{
			super();
			_appKey = appKey;
			create();
		...
		private function init( ):void
		{
			try
			{
				FirebaseDatabase.init( _appKey );
				
				message( "Database Supported: " + FirebaseDatabase.isSupported );
				message( "Database Version:   " + FirebaseDatabase.service.version );
